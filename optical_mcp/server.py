...
from .service import PROJECT_ROOT, OpticalCompressionService
...
def _project_version() -> str:
    try:
        return version("optical-context-mcp")
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="optical-context-mcp",
        description=(
            "Run the Optical Context MCP server over stdio for agent clients such as "
