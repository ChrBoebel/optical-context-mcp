...
The image below is a real packed output artifact produced by this repository during a local validation run.

<p align="center">
  <img src="./assets/example-packed-output.png" alt="Example packed output generated by Optical Context MCP" width="920">
</p>
